...
import me.xiaopan.easyandroid.util.ToastUtils;
...
import com.lixueandroid.util.BleDeviceUtils;
import com.lixueandroid.util.OnScanListener;

public class BlueBleActivity extends ListActivity implements OnClickListener{

	private final static String TAG = BlueBleActivity.class.getSimpleName();
    ...
    protected void onResume() {
        ...
        bleDeviceUtils=new BleDeviceUtils(getBaseContext(),new OnScanListener() {
			@Override
        ...
        if(!bleDeviceUtils.checkIsSupportBleDevice()){
	    	ToastUtils.toastS(getBaseContext(), "你的手机不支持配对BLE设备");
	    	finish();
	    }
        if(!bleDeviceUtils.checkIsHasAdapterNull()){
        	ToastUtils.toastS(getBaseContext(), "你的手机不带有蓝牙设备");
        	finish();
        }
        setListAdapter(mLeDeviceListAdapter);
        bleDeviceUtils.scanLeDevice(true);
    ...
    protected void onPause() {
        super.onPause();
        bleDeviceUtils.scanLeDevice(false);
...
//							}
	 ...
	 private class LeDeviceListAdapter extends BaseAdapter {
	        ...
	        public LeDeviceListAdapter() {
	            ...
	            mInflator =BlueBleActivity.this.getLayoutInflater();
	        }
