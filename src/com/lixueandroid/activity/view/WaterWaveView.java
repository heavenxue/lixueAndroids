...
public class WaterWaveView extends SurfaceView implements SurfaceHolder.Callback{
    ...
    private boolean firstLoad = false;//是否是第一次加载
    ...
    //view的事件，如果大小发生变化时，onMeasure计算view的大小，onLayout计算完大小后，直接画布局大小
    @Override
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
    	   //第一次加载此view时来，把背景图片放上去
            if (!firstLoad) {
                    bgImage = BitmapFactory.decodeResource(this.getResources(),R.drawable.liduohai11);
